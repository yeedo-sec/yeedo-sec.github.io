...
if ($do == 'base_information') {
	...
	if ($_W['ispost'] && $_W['isajax']) {
		...
		if($_GPC['type'] == 'zubie' || $_GPC['type'] == 'huji' || $_GPC['type'] == 'hunyin' || $_GPC['type'] == 'zhengzhimianmao' || $_GPC['type'] == 'gongzuodanwei'){
			$data = array($_GPC['type']  => trim($_GPC['request_data']));
			$result = pdo_update('mc_members', $data, array('uniacid' => $_W['uniacid'], 'uid' => $uid));
		}
